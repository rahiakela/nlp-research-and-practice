...
class CBOWDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # utilizes the Vectorizer to convert the context—the left and right windows—into a vector
        context_vector = self._vectorizer.vectorize(row.context, self._max_seq_length)
        # The target—the word at the center of the window—is converted to an integer using the Vocabulary
