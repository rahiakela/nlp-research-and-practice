...
class CBOWVectorizer(object):
    ...
    def vectorize(self, context, vector_length=-1):
        ...
        """
        # a vector of integers representing the indices of the context is constructed and returned
    ...
    def from_serializable(cls, contents):
        """
        Instantiate a CBOWVectorizer from a serializable dictionary
        Args:
    ...
    def to_serializable(self):
        ...
        """
        return {
            "cbow_vocab": self.cbow_vocab.to_serializable()
        }
